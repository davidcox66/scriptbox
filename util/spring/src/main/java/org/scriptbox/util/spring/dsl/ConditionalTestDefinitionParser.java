 ...
 * @since Jun 29, 2011
 */
public class ConditionalTestDefinitionParser implements BeanDefinitionParser {

  private static Logger LOGGER = LoggerFactory.getLogger( ConditionalTestDefinitionParser.class );
  
	public BeanDefinition parse(Element element, ParserContext parserContext) {
	    if (DomUtils.nodeNameEquals(element, "test")) {
