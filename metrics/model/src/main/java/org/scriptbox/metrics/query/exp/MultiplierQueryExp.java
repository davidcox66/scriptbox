...
public class MultiplierQueryExp implements MetricQueryExp {
	  ...
	  public Object evaluate( final MetricQueryContext ctx ) throws Exception {
	      ...
	      metrics.add( provider2.getMetrics(ctx) );
			...
			MetricCollator collator = new MetricCollator("multiplier", "multiplier", chunk, metrics);
	  ...
	  public String toString() {
	    return "multiplier(child1=" + child1 + ", child2=" + child2 + ")";
	  }
}
