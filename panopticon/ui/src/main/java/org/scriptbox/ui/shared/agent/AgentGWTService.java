...
public interface AgentGWTService extends RemoteService {
	...
	public Map<Agent,String> startContext( List<Agent> endpoints, String contextName, List<String> arguments ) throws ServiceException;
	...
	public Map<Agent,String> loadScript( List<Agent> endpoints, String contextName, String scriptName, String fileName, List<String> arguments ) throws ServiceException;
	public Map<Agent,String> startScript( List<Agent> endpoints, String language, String contextName, String scriptName, String fileName, List<String> arguments ) throws ServiceException;
